...
int main()
{
    ...
    double figure8_scale = 3.0;       
    double constant_altitude = 2.0;   
    double constant_y = 2.0;         
    ...
    // -----------------------------
    std::string gif_command = "convert -delay 30 " + plotDirectory + "/quadrotor_anim_frame_*.png " + plotDirectory + "/quadrotor_figure_eight_vertical.gif";

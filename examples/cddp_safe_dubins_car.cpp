...
int main() {
    ...
    cddp_solver.addConstraint("StateBoxConstraint", 
        std::make_unique<cddp::StateBoxConstraint>(
            Eigen::VectorXd::Constant(state_dim, -.1), 
            Eigen::VectorXd::Constant(state_dim, 2.0)));
    auto control_constraint = cddp_solver.getConstraint<cddp::ControlBoxConstraint>("ControlBoxConstraint");
    auto state_constraint = cddp_solver.getConstraint<cddp::StateBoxConstraint>("StateBoxConstraint");

...
namespace cddp
{
    ...
    struct CDDPOptions
    {
        ...
        // Line search options for IPDDP
        bool use_separate_line_search = false; // Use separate line search for control, slack, and dual variables
        double control_step_size = 1.0;        // Initial step size for control variables
        double slack_step_size = 1.0;          // Initial step size for slack variables
        double dual_step_size = 1.0;           // Initial step size for dual variables
    ...
    struct ForwardPassResult
    {
        ...
        double cost;
        double lagrangian;
        double alpha = 1.0;       // Common alpha or primary alpha for control
        double alpha_slack = 1.0; // Step size for slack variables
        double alpha_dual = 1.0;  // Step size for dual variables
        bool success = false;
    ...
    private:
        ...
        // Line search step sizes for IPDDP
        double alpha_control_; // Line search step size for control
        double alpha_slack_;   // Line search step size for slack
        double alpha_dual_;    // Line search step size for dual

 ...
 * an interior point method based DDP solver for handling inequality
 * constraints. Uses primal-dual interior point method with logarithmic barrier.
 */
...
private:
  ...
  /**
   * @brief Evaluate trajectory by computing cost, constraint values, and merit
   * function.
   * @param context Reference to the CDDP context.
   */
  ...
  /**
   * @brief Initialize dual and slack variables for warm start consistently with
   * provided trajectory.
   * @param context Reference to the CDDP context.
   */
   ...
   */
  void printIteration(int iter, double objective, double inf_pr, double inf_du, double inf_comp,

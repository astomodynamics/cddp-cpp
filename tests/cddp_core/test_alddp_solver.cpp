...
//     cddp::CDDPSolution solution = cddp_solver.solve("ALDDP");
...
//     cddp::CDDPSolution warm_solution = warm_solver.solve("ALDDP");
...
// //     // Solve the problem
// //     std::cout << "\n=== First solve (cold start) ===" << std::endl;
// //     cddp::CDDPSolution solution = cddp_solver.solve("ALTRO");
...
// //     // Solve with warm start
// //     auto start_time = std::chrono::high_resolution_clock::now();
// //     cddp::CDDPSolution warm_solution = warm_solver.solve("ALTRO");
// //     auto end_time = std::chrono::high_resolution_clock::now();
// //     auto warm_duration = std::chrono::duration_cast<std::chrono::milliseconds>(end_time - start_time);
